...
final class WorkoutCommentsService: WorkoutCommentsServicing {
    ...
    private func sendCommentNotification(comment: WorkoutComment, workoutOwnerId: String) async {
    ...
    private func sendReplyNotification(comment: WorkoutComment, parentCommentId: String) async {
        ...
        do {
            ...
            guard let parentUserId = parentRecord["userId"] as? String,
                  parentUserId != comment.userId else { // Don't notify self-replies
                return
            }
...
enum CommentError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .updateFailed:
            return "Failed to update comment. Please try again."
        case .deleteFailed:
