...
final class WorkoutProcessor {
    ...
    init(
        ...
        activitySettingsService: ActivityFeedSettingsProtocol
    ) {
    ...
    private func processWorkout(
        ...
        // CRITICAL: Check if user has a profile before processing
...
enum WorkoutProcessingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .profileRequired:
            return "User profile required to process workouts"
        }
    }
}
