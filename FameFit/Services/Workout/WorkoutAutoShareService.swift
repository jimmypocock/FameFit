...
final class WorkoutAutoShareService: WorkoutAutoShareProtocol {
    private let workoutObserver: any WorkoutObserverProtocol
    private let activityFeedService: ActivityFeedProtocol
    private let activityFeedSettingsService: ActivityFeedSettingsProtocol
    ...
    init(
        workoutObserver: any WorkoutObserverProtocol,
        activityFeedService: ActivityFeedProtocol,
        activityFeedSettingsService: ActivityFeedSettingsProtocol,
