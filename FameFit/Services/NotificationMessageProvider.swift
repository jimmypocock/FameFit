...
final class FameFitMessageProvider: MessageProviding {
    ...
    func getFollowerMessage(username: String, displayName: String, action: String) -> String {
        switch action {
        case "follow":
            return "\(displayName) (@\(username)) is now following your fitness journey!"
        case "kudos":
            return "\(displayName) gave your workout a kudos!"
        case "comment":
            return "\(displayName) commented on your workout"
        case "mention":
            return "\(displayName) mentioned you"
        default:
            return "\(displayName) interacted with your content"
        }
    }
}
