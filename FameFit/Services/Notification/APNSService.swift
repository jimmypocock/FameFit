...
// MARK: - APNS Manager Protocol is defined in Protocols/APNSProtocol.swift

// MARK: - APNS Manager Implementation

class APNSService: NSObject, APNSProtocol {
    ...
    init(cloudKitManager: any CloudKitProtocol, notificationStore: (any NotificationStoringProtocol)? = nil) {
    ...
    func setNotificationStore(_ store: any NotificationStoringProtocol) {
