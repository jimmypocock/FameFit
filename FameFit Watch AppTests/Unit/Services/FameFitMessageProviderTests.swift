...
class FameFitMessageProviderTests: XCTestCase {
    ...
    var messageProvider: FameFitMessageProvider!
    ...
    func testEarlyMorningMessage() {
        ...
        // Then
        XCTAssertFalse(message.isEmpty)
        let morningKeywords = ["5AM", "early", "morning", "Rise", "grind", "dawn", "sunrise", 
                              "Morning", "wake", "sun"]
    ...
    func testEveningMessageIsEncouraging() {
        ...
        let encouragementKeywords = ["amazing", "stronger", "believe", "proud", "crushing", 
                                    "spirit", "doing", "got this", "Beautiful", "inspiring",
                                    "nailing", "progress", "determination", "moment"]
        let containsEncouragement = encouragementKeywords.contains { keyword in
    ...
    func testRunningSpecificRoasts() {
        ...
        let runningKeywords = ["running", "walking", "pace", "turtles", "hustle", "bouncing", 
                              "battery", "stroll", "intensity", "senior citizens", "dead",
                              "confused", "slow-motion", "impressive", "terrible", "sweat",
                              "exercise", "meditating", "standing", "weak", "pretend"]
    ...
    func testStrengthTrainingSpecificRoasts() {
        ...
        let strengthKeywords = ["lifting", "weights", "strength", "paper towel", "warmth",
                               "intensity", "senior citizens", "dead", "confused", "slow-motion",
                               "impressive", "terrible", "sweat", "exercise", "meditating", "standing",
                               "weak", "pretend", "happen", "dignity"]
